param(
    ...
    [string]$Action = "bit",
    [ValidateSet("soc", "soc_sysclk_ila", "soc_bootdiag_sysclk_ila", "hello_sysclk_ila", "bootvec_sysclk_ila", "heartbeat", "heartbeat_direct", "heartbeat_mmcm_ledonly", "heartbeat_mmcm_dualclk", "heartbeat_mmcm_sysclk_ila")]
